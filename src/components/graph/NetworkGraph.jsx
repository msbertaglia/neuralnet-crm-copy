...
export default function NetworkGraph({ contacts, onNodeClick, onNodeDoubleClick, centralContactId, highlightedIds, ancestorIds, filterMode = "completo", layoutModel = "voronoi", orbitDistance = 180 }) {
